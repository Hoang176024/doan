...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First page",sLast:"Last page",sNext:"Next page",sPrevious:"Previous page"},sEmptyTable:"There is not yet data",sInfo:"Display _START_ to _END_ of _TOTAL_ data",sInfoEmpty:"Display 0 to 0 of 0 data",
sInfoFiltered:"(Filter from _MAX_ total data)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Display _MENU_ data",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"There are no matching data"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
